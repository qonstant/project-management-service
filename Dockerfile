...
RUN CGO_ENABLED=0 GOOS=linux GOARCH=amd64 go build -o project-management-service .
...
COPY --from=builder /build/project-management-service ./project-management-service
...
CMD ["./project-management-service"]
